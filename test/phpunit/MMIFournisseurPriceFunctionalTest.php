...
/**
 * \file    test/phpunit/MMIFournisseurPriceFunctionalTest.php
...
/**
 * Class MMIFournisseurPriceFunctionalTest
 *
 ...
 *
 * @package Testmmifournisseurprice
 */
class MMIFournisseurPriceFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMMIFournisseurPrice')->click();
		} else {
			// Disable the module
			$this->byHref('modMMIFournisseurPrice')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/mmifournisseurprice/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mmifournisseurprice/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mmifournisseurprice/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mmifournisseurprice/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mmifournisseurpricewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMMIFournisseurPrice_MMIFournisseurPriceTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMMIFournisseurPrice_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
